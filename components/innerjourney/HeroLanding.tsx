      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto py-8 sm:py-12 lg:py-16">
        ...
        style={{ fontFamily: "Lato" }}>
         A Journey Within to  {" "}
          ...
          <br />
          {/* <span className="bg-gradient-to-r from-[#48c08d] to-[#1abebb] bg-clip-text text-transparent">
            & Soul
          </span> */}
        </h1>
        ...
        <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-white/95 mb-6 sm:mb-8 lg:mb-10 max-w-4xl mx-auto leading-relaxed px-4 font-medium">
          Inner Journey Meditation & Healing Retreat by Anant Gogia
        </p>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-6 mb-8 sm:mb-12 lg:mb-16 px-4">
          <button  onClick={() => setIsModalOpen(true)} className="px-6 sm:px-8 py-3 sm:py-4 bg-[#45a030] hover:bg-[#45a049] text-white rounded-full font-semibold text-base sm:text-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:scale-105 cursor-pointer w-full sm:w-auto">
            Book Your Retreat
            <svg
