    ...
    <section className="w-full bg-gradient-to-b from-green-50 to-white py-20 flex justify-center">
      <div className="bg-white rounded-[20px] py-12 px-10 text-center shadow-[0_10px_30px_rgba(0,0,0,0.08)] w-[calc(100%-200px)] max-w-[1400px]">
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
          <button onClick={() => setIsModalOpen(true)}  className="bg-gradient-to-r from-[#4aaf52] to-[#25b593] text-white px-9 py-4 rounded-full text-base font-semibold inline-flex items-center gap-3 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.15)] w-full sm:w-auto justify-center">
            <svg
              className="w-5 h-5"
              fill="none"
              stroke="currentColor"
