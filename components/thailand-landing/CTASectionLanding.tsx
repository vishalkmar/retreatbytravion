...
const CTASectionLanding = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-br from-[#e0f7fa] via-white to-[#caf0f8]  py-20 flex justify-center relative overflow-hidden">
      {/* Subtle glow overlay */}
      ...
      <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-[20px] py-12 px-10 text-center shadow-[0_10px_40px_rgba(0,0,0,0.2)] w-[calc(100%-200px)] max-w-[1400px]">
        {/* Heading */}
        <h2 className="text-3xl md:text-4xl font-extrabold mb-8 text-[#00a3af] tracking-wide ">
          Rediscover Yourself in the Heart of Thailand
        </h2>

        {/* Subtext */}
        <p className="text-base text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
          Embrace the peaceful charm of Thailand — where golden temples meet
          lush jungles and tranquil beaches. Let each sunrise guide your soul
          toward balance, renewal, and mindful serenity.
        </p>
