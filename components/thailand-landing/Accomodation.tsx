...
import { lato } from "@/lib/fonts"; // ✅ import Lato font from lib/fonts

const badroom = "/thailand/accomodation/badroom.jpeg";
...
const carouselImages = [
  {
    ...
    description:
      "Wake up to ocean views and golden sands at Thailand’s most elegant coastal retreat.",
  },
  {
    ...
    description:
      "Private pool villas surrounded by lush tropical greenery for the ultimate relaxation.",
  },
  {
    ...
    description:
      "Modern comfort and cityscape views right in the vibrant heart of Bangkok.",
  },
  {
    ...
    description:
      "Immerse in nature with sustainable luxury surrounded by mountain tranquility.",
  },
  {
    ...
    description:
      "A tropical sanctuary featuring overwater villas and panoramic sea views.",
  },
];
...
export default function HotelResortHero() {
  ...
  return (
    <div
      className={`min-h-screen pt-[60px] w-full overflow-hidden bg-gradient-to-br from-[#e0f7fa] via-white to-[#caf0f8] relative ${lato.className}`} // ✅ font applied globally inside this section
    >
      {/* ---------------- HERO SECTION ---------------- */}
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
          ...
          <div className="text-white space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="px-8 py-3 rounded-full bg-[#00b4d8] text-white font-semibold shadow-md hover:bg-[#0096c7] hover:shadow-lg transition-all duration-300 uppercase text-sm font-medium tracking-wider">
                Read More
              </button>
            </div>
          </div>
